...
# show_animation = True
show_obstable_animation = True
show_searching_animation = True
...
class AStarPlanner:
    ...
    def __init__(self, ox, oy, resolution, rr):
        ...
        self.motion = self.get_neighbouring_node() # motion model for grid search expansion
    ...
    def planning(self, sx, sy, gx, gy):
        ...
        while 1: # while
            ...
            # show graph
            if show_searching_animation:  # pragma: no cover
...
def main():
    ...
    if show_obstable_animation:  # pragma: no cover
        plt.plot(ox, oy, ".k") # plot the obstacle
        plt.plot(sx, sy, "ob") # plot the start position 
        plt.plot(gx, gy, "og") # plot the end position
        plt.grid(True) # plot the grid to the plot panel
        plt.axis("equal") # set the same resolution for x and y axis 

    a_star = AStarPlanner(ox, oy, grid_size, robot_radius) # class
    rx, ry = a_star.planning(sx, sy, gx, gy) # rx (1,2,3,4,4..) ry (2,3,,5..)

    if show_final_path:  # pragma: no cover
